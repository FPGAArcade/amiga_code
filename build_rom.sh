...
romtool -v build -o replay.rom -t ext -s 64 -e f00000 -a f00010 -r 01.08 -f bootrom/bootrom.bin addmem/AddReplayMem poseidon/PoseidonLoader rtc/battclock.resource usb/usb_eth.autoconfig usb/replayusb.device eth/replayeth.device sdcard/replaysd.device rtg/Replay.card
