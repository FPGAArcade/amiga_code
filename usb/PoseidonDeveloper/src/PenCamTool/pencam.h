...
struct NepPencamBase
{
    struct Library      np_Library;       /* standard */
    UWORD               np_Flags;         /* various flags */

    struct Library     *np_PsdBase;       /* Poseidon base */
    struct ExecBase    *np_SysBase;       /* cached execbase */
...
struct NepClassPencam
{
    ...
    struct NepPencamBase *nch_PencamBase; /* library pointer */
    ...
    ULONG               nch_BulkPktSize;  /* Size of EP1 packets */
    ...
    struct vhi_dimensions nch_Dims;       /* VHI image size */
    BOOL                nch_TrustMe;      /* Trust me mode toggle */
