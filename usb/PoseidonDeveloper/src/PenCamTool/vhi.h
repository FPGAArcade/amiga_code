...
/* Error-Messages */
#define VHI_ERR_UNKNOWN_METHOD   1L // Means: This method is unknown
#define VHI_ERR_COULD_NOT_INIT   2L // Means: The board couldn`t be initialized
#define VHI_ERR_NO_HARDWARE      3L // Means: The hardware required by this driver wasn`t found
#define VHI_ERR_NO_INPUT_DATA    4L // Means: There is no signal at the selected input
#define VHI_ERR_ERR_WHILE_DIG    5L // Means: An error occured while getting the video data
#define VHI_ERR_OUT_OF_MEMORY    6L // Means: Not enough memory
#define VHI_ERR_INTERNAL_ERROR   7L // Means: Internal driver error
...
// TODO: Add code to print these to VHI Studio
...
struct vhi_dimensions
{
        ...
        ULONG dst_width;  // The size to scale the data to.
        ULONG dst_height;
};
...
struct vhi_image
{
        ...
        BOOL scaled;  // Image has been scaled internally (not important for DC-drivers)
};
